...
* [br-avg](br-avg.md)
* [br-col-avg](br-col-avg.md)
* [br-none](br-none.md)
* [br-same-size](br-same-size.md)

## White reference methods
* [wr-annotation-avg](wr-annotation-avg.md)
* [wr-col-avg](wr-col-avg.md)
* [wr-none](wr-none.md)
* [wr-same-size](wr-same-size.md)

## Reference locators
* [rl-file-pattern](rl-file-pattern.md)
* [rl-fixed](rl-fixed.md)
