...
def main():
    ...
    parser.add_argument("-o", "--output", metavar="PATH", help="The directory to store the help in; outputs it to stdout if not supplied; if pointing to a directory, automatically generates file name from plugin name and help format", type=str, default=None, required=False)
